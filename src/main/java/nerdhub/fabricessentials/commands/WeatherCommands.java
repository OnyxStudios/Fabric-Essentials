...
public class WeatherCommands {
    ...
    public static void registerWeatherCommands() {
        CommandRegistry.INSTANCE.register(false, serverCommandSourceCommandDispatcher -> ServerCommandManager.literal("toggledownfall")
                ...
                .executes(context -> {
                    ...
                    if(playerEntity.world.hasRain(playerEntity.getPos())) {
                        ...
                        playerEntity.addChatMessage(new TranslatableTextComponent("weather.clearweather").setStyle(new Style().setColor(TextFormat.GOLD)), true);
                    }else {
                        ...
                        context.getSource().getWorld().getLevelProperties().setThundering(false);
                        playerEntity.addChatMessage(new TranslatableTextComponent("weather.rainweather").setStyle(new Style().setColor(TextFormat.GOLD)), true);
                    }
